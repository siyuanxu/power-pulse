...
点击菜单栏中的 Power Pulse 瓦数，再选择“打开功率曲线…”。曲线复用菜单栏的 5 秒采样，不会额外轮询硬件；功率与电池电量百分比同步记录，自动保留最近 24 小时，跨应用重启继续记录。顶部的“平均功耗”和图内虚线按当前选择的时间范围，由整机功耗样本实时计算；电量曲线的“平均耗电”按电池供电时段的净电量下降百分点除以时长计算，充电时段不计入。切换 15 分钟、1 小时、6 小时或 24 小时会同步重算。
